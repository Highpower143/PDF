...
bot = telebot.TeleBot('7235923720:AAEqSa0H8YQnaWWugBAWJm54te_9HgbPz4A')
...
JOIN EVERYONE - https://t.me/addlist/RpDpFE1rHFFiYWJl ❤️‍🩹

REGARDS - @TMZEROO✅ : JOIN GROUP - @V2DDOS ✅''')
            except Exception as e:
...
def run_attack_and_notify(message, user_id, target, port, time):
    ...
    if success:
        ...
        bot.reply_to(message, "*Your Attack is Finished Please Send Feedback With @v2ddos✅*")
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @TMZEROO✅"
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, Brother Only 1 Plan Is Powerfull Then Any Other Ddos and That is @nandyadu1c ✅!!:
...
Week-->250 Rs
Month-->750 Rs
LINKS OF OUR PAID AND FREE - https://t.me/addlist/RpDpFE1rHFFiYWJl ❤️‍🩹
'''
    bot.reply_to(message, response)
